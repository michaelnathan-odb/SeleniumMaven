...
public class Subscription {
    ...
    public static String dropdownId = "//select[contains(@id, 'control-country-')]";
    ...
    //printed subscription form
//    public static String closeCookie = "//i[@class='moovegdpr-arrow-close']";
...
//        new Actions(driver).scrollToElement(scroll).perform();
    ...
    public void clickPrintSubs(){
        ...
        WebElement scroll = driver.findElement(By.name(emailNameP));
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
        new Actions(driver).scrollToElement(scroll).perform();
    }
...
//        driver.findElement(By.xpath(closeCookie)).click();
    ...
    public void emailFieldAll(){
        ...
        driver.findElement(By.xpath(dropdownId)).sendKeys(formData.country);
    ...
    public void submitFormPrint(){driver.findElement(By.xpath(submitBtnXpathP)).click();}
    public void submitFormEmail(){driver.findElement(By.xpath(submitBtnXpath)).click();}
